...
import { close } from '../store/features/modalState'
...
export default function Modal() {
  ...
  const modalOpen = useSelector((state) => state.modalState.value)
  ...
  const uploadPost = async () => {
    ...
    // 4) get a download URL from firebase storage and update to original post
  ...
  return (
    <Transition.Root show={modalOpen} as={Fragment}>
      ...
      >
        <div
          className="flex min-h-[800px] items-end justify-center px-4 
          pt-4 pb-20 text-center sm:block sm:min-h-screen sm:p-0"
        >
          <Transition.Child
            as={Fragment}
